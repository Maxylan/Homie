...
class Message(SQLModel, table=True):
    ...
    sent: str = Field(default="CURRENT_TIMESTAMP", not_null=True)
...
Constraints such as NOT NULL and DEFAULT are provided using the not_null and default parameters within the Field class.
