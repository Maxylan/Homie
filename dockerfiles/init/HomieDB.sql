...
CREATE TABLE IF NOT EXISTS HomieDB.`g_access_logs` (
    ...
    `username` INT UNSIGNED DEFAULT null,
...
CREATE TABLE IF NOT EXISTS HomieDB.`g_platforms` (
    ...
    `guest_code` VARCHAR(63) NOT NULL UNIQUE,
    `member_code` VARCHAR(63) NOT NULL UNIQUE,
...
CREATE TABLE IF NOT EXISTS HomieDB.`g_exports` (
    ...
    FOREIGN KEY (`platform_id`) REFERENCES g_platforms(`id`) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS HomieDB.`user_avatars` (
    ...
    FOREIGN KEY (`avatar`) REFERENCES attachments(`id`) ON DELETE CASCADE,
    FOREIGN KEY (`avatar_sd`) REFERENCES attachments(`id`) ON DELETE SET null
);
...
CREATE TABLE IF NOT EXISTS HomieDB.`g_products` (
    ...
    FOREIGN KEY (`changed_by`) REFERENCES users(`id`) ON DELETE SET null,
    FOREIGN KEY (`changed_by_platform`) REFERENCES g_platforms(`id`) ON DELETE SET null
);
...
CREATE TABLE IF NOT EXISTS HomieDB.`recipes` (
    ...
    FOREIGN KEY (`cover`) REFERENCES attachments(`id`) ON DELETE SET null,
    FOREIGN KEY (`cover_sd`) REFERENCES attachments(`id`) ON DELETE SET null,
    FOREIGN KEY (`ingredients_list_id`) REFERENCES lists(`id`) ON DELETE SET null,
    FOREIGN KEY (`todo_list_id`) REFERENCES lists(`id`) ON DELETE SET null,
    FOREIGN KEY (`author`) REFERENCES users(`id`) ON DELETE SET null,
    FOREIGN KEY (`changed_by`) REFERENCES users(`id`) ON DELETE SET null
);
